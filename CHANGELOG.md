...
- Fixed lint formatting (black, isort) across test and source files
- Corrected author email in pyproject.toml
- Fixed pre-commit config (removed Python 3.11 pin, removed broken mypy hook)
